var marry = new Scene({
  background: { filename: '/sevn/the-question/img/black.png', effect: 'dissolve' },
  inherit: ['audio']
})
...
marry.push([
  ...
  [
    rightaway.change_background({ filename: '/sevn/the-question/img/club.jpg', effect: 'dissolve' }),
  ...
  [
    sylvie.change_image({filename: "/sevn/the-question/img/sylvie2_normal.png", position: s2_pos }),
    sylvie.say("Hey...")
  ],
  me.say("Yes?"),

  [
    sylvie.change_image({filename: "/sevn/the-question/img/sylvie2_giggle.png", position: s2_pos }),
    sylvie.say("Marry me!")
  ],
  me.say("What???"),

  [
    sylvie.change_image({filename: "/sevn/the-question/img/sylvie2_surprised.png", position: s2_pos }),
    sylvie.say("Well, don't you love me?")
  ],
  me.say("I do, actually."),

  [
    sylvie.change_image({filename: "/sevn/the-question/img/sylvie2_smile.png", position: s2_pos }),
  ...
  me.say("Hmmm… that's a nice thought."),
  ...
  [
    rightaway.change_background({ filename: '/sevn/the-question/img/black.png', effect: 'dissolve' }),
